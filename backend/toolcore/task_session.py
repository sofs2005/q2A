...
def build_continuation_prompt(
    ...
    *,
    ...
    lines = [
        ...
        '',
        'CRITICAL TOOL CALL FORMAT - MUST USE SAFE JSON BLOCK:',
        '##TOOL_CALL##',
        ...
        '',
        'EXECUTION RULES:',
        '- When you need to call a tool, output EXACTLY the safe JSON block format above',
        '- Do not use XML-like tool-call formats, markdown fences, or native platform tool calls',
