    ...
    if opencode_override and tools_part:
        tools_part = "\n".join(
            [
                ...
                "For this qwen2API bridge, EVERY tool call MUST use ONLY the safe ##TOOL_CALL## JSON block below.",
                "If you need to inspect files or directories, call the tool immediately using that safe JSON block.",
